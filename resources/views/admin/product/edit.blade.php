                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-4 col-sm-4 col-4">
                                            <div class="form-group">
                                                <label>Cost per pc
                                                    <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" min="1" name="cost_per_pc" value="{{ $product->cost_per_pc }}" placeholder="Cost" />
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-md-4 col-sm-4 col-4">
                                            <div class="form-group">
                                                <label>Cost per bundle
                                                    <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" min="1" id="cost_per_bundle" name="cost_per_bundle" value="{{ $product->cost_per_bundle }}" placeholder="Cost" />
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-md-4 col-sm-4 col-4">
                                            <div class="form-group">
                                                <label>Cost per half
                                                    <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" min="1" name="cost_per_half" id="cost_per_half" value="{{ $product->cost_per_half }}" placeholder="Cost" />
                                            </div>
                                        </div>
