...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">Show<span></span></li>
    </ol>
</nav>
@endsection
@section("content")
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                            ...
                                            <select class="form-control basic" name="product_id" id="product_id_1" disabled>
                                        ...
                                        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                                            <div class="form-group">
                                                <label>Supplier
                                                    <span class="text-danger">*</span></label>
                                                <select class="form-control basic" name="supplier_id" id="supplier_id_1" disabled>
                                        ...
                                        <div class="col-xl-6 col-md-6 col-sm-6 col6" id="quantity_per_half">
                                            <div class="form-group">
                                                <label>Min Quantity 
                                                    <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" min="1" id="quantity_per_half_ipt" disabled name="min_quantity" value="{{ $reordering->min_quantity }}" placeholder="Quantity" />
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-sm-6 col-6" id="quantity_per_bundle">
                                            <div class="form-group">
                                                <label>Quantity 
                                                    <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" name="quantity" disabled id="quantity_per_bundle_ipt" value="{{ $reordering->quantity }}"  placeholder="Quantity" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
