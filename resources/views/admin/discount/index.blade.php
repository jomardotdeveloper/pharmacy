...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page"><span>Discounts</span></li>
    </ol>
</nav>
@endsection
@section("content")
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="container p-0">
                <a href="{{route('discounts.create')}}" class="btn btn-primary">Create</a>
                <div class="row layout-top-spacing date-table-container">
                    <!-- BASIC -->
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <h4 class="table-header">All Discounts</h4>
                                ...
                                <table id="basic-dt" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($discounts as $discount)
                                            <tr>
                                                <td>
                                                    <a href="{{route('discounts.show', ['discount' => $discount])}}" title="Edit" class="text-primary">
                                                        {{$discount->name}}
                                                    </a>
                                                </td>
