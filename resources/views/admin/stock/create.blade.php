                                                    ...
                                                    <tr id="line_1">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <label>Supplier
                                                                    <span class="text-danger">*</span></label>
                                                                <select class="form-control basic" name="supplier_id_1" id="supplier_id_1" required>
    ...
    var app = new Vue({
        ...
        methods: {
            addNewLine: function() {
                ...
                var expiration_date = cloned.children("td").eq(3).children().eq(0).children().eq(1);
                expiration_date.attr("name", "expiration_date_" + current_number);
                expiration_date.attr("id", "expiration_date_" + current_number);

                var supplier = cloned.children("td").eq(4).children().eq(0).children().eq(1);
                supplier.attr("name", "supplier_id_" + current_number);
                supplier.attr("id", "supplier_id_" + current_number);
