...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item" aria-current="page"><span>Sales History</span></li>
    </ol>
</nav>
@endsection
@section("content")
                ...
                <div class="row layout-top-spacing date-table-container">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <h4 class="table-header">All Sales</h4>
                            <div class="row">
                            ...
                            <div class="table-responsive mb-4">
                                <table id="basic-dt" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{ route('sales.sale.show', ['id' => $sale->id]) }}" class="text-primary">
                                                    {{ $sale->formatted_number }}
                                                </a>
                                            </td>
                                            <td>{{ date_format(date_create($sale->sale_date), 'F d, Y') }}</td>
